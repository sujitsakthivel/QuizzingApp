...
export class PlayquizComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.studentService.getQuizId() == undefined) {
      ...
      this.creatoremail = this.studentService.getCreatorEmail();
  ...
  lastsubmit() {
    this.getScore();
    this.obj = {quizId:this.quizid,creatorEmail:this.creatoremail,score:this.score,taken:true}
    this.studentService.addTaken(this.obj)
      .subscribe(
        data => {
        },
        error =>
