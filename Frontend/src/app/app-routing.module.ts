...
import { GetmarksComponent } from './teacher/getmarks/getmarks.component';
...
import { EditquizComponent } from './teacher/editquiz/editquiz.component';
import { UploadedquestionComponent } from './teacher/uploadedquestion/uploadedquestion.component';
...
import { EditquestionComponent } from './teacher/editquestion/editquestion.component';
import { IndexheaderComponent } from './index/indexheader/indexheader.component';
...
const routes: Routes = [
  ...
  { path: 'teacher/getmarks', component: GetmarksComponent, canActivate: [TeacherGuard] },
  ...
  { path: 'teacher/editquiz', component: EditquizComponent, canActivate: [TeacherGuard] },
  { path: 'teacher/uploadedquestion', component: UploadedquestionComponent, canActivate: [TeacherGuard] },
  ...
  { path: 'teacher/editquestion', component: EditquestionComponent, canActivate: [TeacherGuard] },
  // student
